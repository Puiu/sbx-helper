#!/usr/bin/env bash
#
# Builds the combined .NET 10 + Swift 6 Claude Code sandbox image, exports
# it, loads it into sbx's local template store, and starts a sandbox from
# it.
#
# Usage:
...
#   IMAGE_TAG   (default: v2)  -- bump this each time you rebuild
#
set -euo pipefail
