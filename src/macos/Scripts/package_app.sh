...
APP_NAME=${APP_NAME:-SbxHelperApp}
# Stable forever once real users exist — TCC grants (Automation access to
# iTerm, folder access) are keyed to this identifier. See PLAN.md.
BUNDLE_ID=${BUNDLE_ID:-com.alexalbu.sbx-helper}
...
<dict>
    ...
    <key>NSAppleEventsUsageDescription</key><string>sbx-helper opens a new iTerm2 window to run the sbx command you assembled.</string>
    <key>NSDesktopFolderUsageDescription</key><string>sbx-helper lets you pick folders anywhere on your Mac, including the Desktop, to build sbx commands.</string>
    <key>NSDocumentsFolderUsageDescription</key><string>sbx-helper lets you pick folders anywhere on your Mac, including Documents, to build sbx commands.</string>
    <key>NSDownloadsFolderUsageDescription</key><string>sbx-helper lets you pick folders anywhere on your Mac, including Downloads, to build sbx commands.</string>
    <key>NSRemovableVolumesUsageDescription</key><string>sbx-helper lets you pick folders on external volumes to build sbx commands.</string>
